...
var countDownDate = new Date("Jan 1, "+ getYear +" 15:37:25").getTime();
...
var countdownfunction = setInterval(function() {
 ...
 document.getElementById("timersquare").innerHTML = '<div class="days"><span class="count">' + days + '</span> <span class="text">Days</span></div>' +
 '<div class="hours"><span class="count">'+ hours +'</span> <span class="text">Hours</span></div>' +
 '<div class="min"><span class="count">'+ minutes +'</span> <span class="text">Mins</span></div>' +
 '<div class="sec"><span class="count">'+ seconds +'</span> <span class="text">Secs</span></div>';
 document.getElementById("nocolor").innerHTML = '<div class="days"><span class="count">' + days + '</span> <span class="text">Days</span></div>' +
 '<div class="hours"><span class="count">'+ hours +'</span> <span class="text">Hours</span></div>' +
 '<div class="min"><span class="count">'+ minutes +'</span> <span class="text">Mins</span></div>' +
 '<div class="sec"><span class="count">'+ seconds +'</span> <span class="text">Secs</span></div>';
  ...
  if (distance < 0) {
    clearInterval(countdownfunction);
    document.getElementById("timersquare").innerHTML = "EXPIRED";
  }
  if (distance < 0) {
    clearInterval(countdownfunction);
