(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
  ...
  .on('drag', function (el) {
    el.className += ' drag-type-1';
  }).on('drop', function (el) {
    el.className = el.className.replace('drag-type-1', '');
  }).on('cancel', function (el) {
    el.className = el.className.replace('drag-type-1', '');
  });
  dragula([$('left-drag-any'), $('right-drag-any')])
  .on('drag', function (el) {
    el.className += ' drag-anything';
  }).on('drop', function (el) {
    el.className = el.className.replace('drag-anything', '');
  }).on('cancel', function (el) {
    el.className = el.className.replace('drag-anything', '');
  });
  ...
  .on('drag', function (el) {
    el.className += ' drag-type-2';
    el.className = el.className.replace('ex-moved', '');
  }).on('drop', function (el) {
    el.className = el.className.replace('drag-type-2', '');
    el.className += ' ex-moved';
  }).on('cancel', function (el) {
    el.className = el.className.replace('drag-type-2', '');
  });
  dragula([$('left-lovehandles'), $('right-lovehandles')], {
    ...
    el.className += ' drag-type-3';
  }).on('drop', function (el) {
    el.className = el.className.replace('drag-type-3', '');
  }).on('cancel', function (el) {
    el.className = el.className.replace('drag-type-3', '');
  })
  function $ (id) {
